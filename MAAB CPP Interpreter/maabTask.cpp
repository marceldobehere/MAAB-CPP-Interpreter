...
void TaskMAAB::ShowBytes(uint8_t amount, uint64_t addr)
{
	...
	for (int i = 0; i < amount; i++)
		newTerm->Print("{} ", to_string((uint8_t)((void*)mem[addr + i])));
	newTerm->Print(">");
}
...
#pragma region INT
	...
	{
		int32_t from = (int32_t)((void*)mem[addrFrom]);
...
#pragma region UINT
	...
	{
		uint32_t from = (uint32_t)((void*)mem[addrFrom]);
...
#pragma region SHORT
	...
	{
		int16_t from = (int16_t)((void*)mem[addrFrom]);
...
#pragma region USHORT
	...
	{
		uint16_t from = (uint16_t)((void*)mem[addrFrom]);
...
#pragma region LONG
	...
	{
		int64_t from = (int64_t)((void*)mem[addrFrom]);
...
#pragma region ULONG
	...
	{
		uint64_t from = (uint64_t)((void*)mem[addrFrom]);
...
#pragma region CHAR
	...
	{
		char from = (char)((void*)mem[addrFrom]);
...
#pragma region BOOL
	...
	{
		bool from = (bool)((void*)mem[addrFrom]);
